...
int
GlobalUtil::CreateCommand(RedisModuleCtx *ctx, string fName, RedisModuleCmdFunc cmdfunc, string strflags, int firstkey,
...
GlobalUtil::BlockClient(RedisModuleCtx *ctx, RedisModuleCmdFunc reply_callback, RedisModuleCmdFunc timeout_callback,
