...
namespace ms::redis {
  ...
  public:
    static int
    CreateCommand(RedisModuleCtx *ctx, string fnName, RedisModuleCmdFunc cmdfunc, string strflags, int firstkey,
    ...
    static RedisModuleBlockedClient *
    BlockClient(RedisModuleCtx *ctx, RedisModuleCmdFunc reply_callback, RedisModuleCmdFunc timeout_callback,
